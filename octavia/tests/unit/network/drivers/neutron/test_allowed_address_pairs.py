...
class TestAllowedAddressPairsDriver(base.TestCase):
    ...
    def test_plug_vip_amp__port_create_fails(self, mock_convert):
        lb = dmh.generate_load_balancer_tree()
    ...
    def test_plug_vip_amp_port_attach_fails(self):
        ...
        port2 = t_constants.MOCK_MANAGEMENT_PORT2['port']
        list_ports.side_effect = [{'ports': [port1]}, {'ports': [port2]}]
        network_attach = self.driver.nova_client.servers.interface_attach
