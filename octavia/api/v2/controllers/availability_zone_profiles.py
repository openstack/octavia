...
class AvailabilityZoneProfileController(base.BaseController):
    ...
    def get_one(self, id, fields=None):
        ...
        with context.session.begin():
            availability_zone_profile = self._get_db_availability_zone_profile(
                context.session,
                id
            )
            ...
            result = (
                ...
                .from_db_obj(availability_zone_profile)
            )
    ...
    def get_all(self, fields=None):
        ...
        with context.session.begin():
            availability_zone_profiles, links = (
                self.repositories.availability_zone_profile.get_all_orm(
                    context.session, pagination_helper=pcontext.get(
                        constants.PAGINATION_HELPER)))

            result = [
                profile_types.AvailabilityZoneProfileResponse
                .from_db_obj(availability_zone_profile)
                for availability_zone_profile in availability_zone_profiles
            ]
        ...
        try:
            ...
            if not isinstance(availability_zone_profile.availability_zone_data,
                ...
                if isinstance(availability_zone_profile.provider_name,
                    ...
                    provider_driver = (
                        db_availability_zone_profile.provider_name
                    )
                else:
