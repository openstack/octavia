...
class L7RuleController(base.BaseController):
    ...
    def get(self, id, fields=None):
        ...
        with context.session.begin():
            ...
            result = l7rule_types.L7RuleResponse.from_db_obj(l7rule)
    ...
    def get_all(self, fields=None):
        ...
        with context.session.begin():
            ...
            l7rules, links = self.repositories.l7rule.get_all_API_list(
                context.session,
                show_deleted=False,
            ...
            result = [
                l7rule_types.L7RuleResponse.from_db_obj(l7rule)
    ...
    def post(self, rule_):
        ...
        with context.session.begin():
            l7rule = self._get_db_l7rule(context.session, db_l7rule.id)
            result = l7rule_types.L7RuleResponse.from_db_obj(l7rule)
    ...
    def put(self, id, l7rule_):
        ...
        with context.session.begin():
            l7rule = self._get_db_l7rule(context.session, id)
            result = l7rule_types.L7RuleResponse.from_db_obj(l7rule)
